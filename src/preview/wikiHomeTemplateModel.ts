...
export const wikiHomeTemplateLayout = {
  ...
  summaryBanner: summaryLayout.summaryBanner,
...
const expectedChecks: Array<{ label: string; actual: unknown; expected: unknown }> = [
  ...
  { label: "Content frame", actual: wikiHomeTemplateLayout.content, expected: { bodyRelativeX: 32, bodyRelativeY: 20, width: 936, height: 604, gap: 12 } },
  { label: "Summary banner", actual: wikiHomeTemplateLayout.summaryBanner, expected: { contentRelativeX: 0, contentRelativeY: 0, width: 936, height: 100 } },
  { label: "Summary frame", actual: wikiHomeTemplateLayout.summary.bodyRelativeFrame, expected: { x: 52, y: 42, width: 170, height: 56 } },
  { label: "Summary title row", actual: wikiHomeTemplateLayout.summary.titleRow, expected: { x: 0, y: 0, width: 170, height: 28, gap: 4 } },
  { label: "Summary meta row", actual: wikiHomeTemplateLayout.summary.metaRow, expected: { x: 0, y: 36, width: 132, height: 20, gap: 4 } },
  { label: "Category grid frame", actual: wikiHomeTemplateLayout.grid, expected: { contentRelativeX: 0, contentRelativeY: 112, width: 936, height: 492 } },
  ...
  { label: "Home scrollbar", actual: wikiHomeTemplateLayout.scrollbar, expected: { absoluteX: 988, absoluteY: 68, width: 12, height: 542, thumbWidth: 4, thumbHeight: 80, thumbY: 8 } },
];
