...
const checks = [
  ...
  { label: "Body frame", actual: grid.body, expected: { x: 0, y: 84, width: 1000, height: 526 } },
  ...
  { label: "Home scrollbar", actual: grid.scrollbar, expected: { absoluteX: 988, absoluteY: 84, width: 12, height: 526, thumbWidth: 4, thumbHeight: 80, thumbY: 119 } },
  ...
  { label: "Detail all-states content shell", actual: detailShell.allStates.detailContent, expected: { bodyRelativeX: 20, bodyRelativeY: 64, absoluteX: 20, absoluteY: 144, width: 960, height: 1022 } },
  { label: "Detail all-states scroll", actual: detailShell.allStates.scroll, expected: { bodyRelativeX: 980, bodyRelativeY: 60, absoluteX: 980, absoluteY: 140, width: 12, height: 1015 } },
